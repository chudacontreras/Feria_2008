...
<table width="89%" height="0" border="1" align="center">
  <tr>
    <td height="467"><table width="100%" border="0">
      <tr>
        <td width="11%" align="center" valign="middle"><a href="ppal.php"><img src="imagenes/alcaldia.jpg" width="40" height="69" border="0" /></a></td>
        ...
        <td width="13%" align="center" valign="middle"><a href="ppal.php"><img src="imagenes/cortubar.gif" width="101" height="56" border="0" /></a></td>
    ...
    <td height="467"><table width="100%" border="0">
      <tr>
        ...
        <td width="44%" align="center" valign="middle">
		  ...
		  R.I.F.: G20006212-6          </span></td>
        <td width="13%" align="center" valign="middle"><a href="ppal.php"><img src="imagenes/cortubar.gif" width="101" height="56" border="0" /></a></td>
        <td width="32%" align="center" valign="middle"><span class="Estilo8"><?php echo $codigo ?><br>
        </span>          <?php  echo $filaF['fecha'];  ?></td>
      </tr>
    </table>
