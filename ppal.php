...
<table width="650" height="434" border="1" align="center">
  <tr>
    <td width="222" rowspan="2" align="center"><img src="imagenes/afihe.gif" width="213" height="425" /></td>
...
Boleter&iacute;a-Abonos</font><br /><br />
        <form method="post" action="datos.php">
			<font size="2" face="Arial, Helvetica, sans-serif"><strong>Introduzca la Cédula:</strong></font><br><br>
